...
bool BouillabaissePlugin::initialize(const QStringList &arguments, QString *errorString)
{
  ...
  QAction *action = new QAction(tr("Bouillabaisse action"), this);
  ...
  menu->menu()->setTitle(tr("Bouillabaisse"));
  menu->addAction(cmd);
...
void BouillabaissePlugin::triggerAction()
{
  QMessageBox::information(Core::ICore::mainWindow(),
                           tr("Action triggered"),
                           tr("This is an action from Bouillabaisse."));
}
